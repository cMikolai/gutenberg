 ...
 */
function gutenberg_auto_save_get_sample_permalink( $permalink, $id, $title, $name, $post ) {
...
add_filter( 'get_sample_permalink', 'gutenberg_auto_save_get_sample_permalink', 10, 5 );